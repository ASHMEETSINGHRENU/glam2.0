...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/blush-3.jpg" width="100%" alt="">
            </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute blush Color -skin tone </h4>
            <h2> ₹799 </h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=blush&id=3"><button> ADD To Cart</button></a>
