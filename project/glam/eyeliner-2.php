...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/eyeliner-2.jpg" width="100%" alt="">
            </div>
        ...
        <div class="single-pro-details">
            <h6> MAC </h6>
            <h4>Asoloute eyeliner - Black /300gm</h4>
            <h2> ₹569 </h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=eyeliner&id=2"><button> ADD To Cart</button></a>
