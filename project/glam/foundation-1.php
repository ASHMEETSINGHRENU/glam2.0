...
<head>
    ...
    <link rel="stylesheet" href="style/foundation-1.css">
...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/foundation-1.jpg" width="100%" alt="">
            </div>

            <div class="small-img-group">
                
                <div class="small-img-col" onclick="changeImage('images/foundation-1.jpg')">
                <img id="small-image" src="images/foundation-1.jpg" width="100%" alt=""  >
                </div>

                <div class="small-img-col" onclick="changeImage('images/foundation-2.jpg')">
                <img id="small-image" src="images/foundation-2.jpg" width="100%" alt="">
                </div>

                <div class="small-img-col" onclick="changeImage('images/foundation-3.jpg')">
                <img id="small-image" src="images/foundation-3.jpg" width="100%" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute fondation </h4>
            <h2> ₹999 </h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=foundation&id=1"> <button> ADD To Cart</button> </a>
            <h4> product details </h4>
            <span>This absolute foundation is a very basic need of your makeup routine . Do try according to your skin shade 
                , the best one is waiting for you.</span>
        </div>
    </section>
...
<div class="pro-container">
    ...
    <div class="last_icon">
        <div class="last_icon_cus">
          ...
          <script src="foundation-1.js"></script>
</body>
</html>