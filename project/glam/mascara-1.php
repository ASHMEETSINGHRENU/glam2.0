...
<head>
    ...
    <link rel="stylesheet" href="style/mascara-1.css">
...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/mascara-1.jpg" width="100%" alt="">
            </div>

            <div class="small-img-group">
                
                <div class="small-img-col" onclick="changeImage('images/mascara-1.jpg')">
                <img id="small-image" src="images/mascara-1.jpg" width="100%" alt=""  >
                </div>

                <div class="small-img-col" onclick="changeImage('images/mascara-2.jpg')">
                <img id="small-image" src="images/mascara-2.jpg" width="100%" alt="">
                </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute Mascara Brown /300gm</h4>
            <h2> ₹599 </h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=mascara&id=1"> <button> ADD To Cart</button> </a>
            <h4> product details </h4>
            <span>This Mascara is a one time apply thing .That is the must to use cosmatic product with waterproof resistance .</span>
        </div>
    </section>
...
<div class="pro-container">
    ...
    <div class="last_icon">
        <div class="last_icon_cus">
          ...
          <script src="mascara-1.js"></script>
</body>
</html>