...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/serum-1.jpg" width="100%" alt="">
            </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute Serum- face glow/250gm </h4>
            <h2> ₹1999 </h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=serum&id=1"> <button> ADD To Cart</button> </a>
