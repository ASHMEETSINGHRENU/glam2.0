...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/kajal-2.jpg" width="100%" alt="">
            </div>
            ...
            <div class="small-img-group">
                ...
                <img id="small-image" src="images/kajal-2.jpg" width="100%" alt="">
                </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute kajal - black </h4>
            <h2> ₹449</h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=kajal&id=2"><button> ADD To Cart</button></a>
