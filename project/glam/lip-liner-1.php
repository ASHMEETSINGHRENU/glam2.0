...
<head>
    ...
    <link rel="stylesheet" href="style/lip-liner-1.css">
...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/lip-liner-1.jpeg" width="100%" alt="">
            </div>

            <div class="small-img-group">
                
                <div class="small-img-col" onclick="changeImage('images/lip-liner-1.jpeg')">
                <img id="small-image" src="images/lip-liner-1.jpeg" width="100%" alt=""  >
                </div>

                <div class="small-img-col" onclick="changeImage('images/lip-liner-2.jpeg')">
                <img id="small-image" src="images/lip-liner-2.jpeg" width="100%" alt="">
                </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute Ultimate Lip liner Color(light shade) </h4>
            <h2> ₹299 </h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=lip-liner&id=1"><button> Add To Cart </button> </a> 
            <h4> product details </h4>
            <span>This soft matte lip liner has an intense colour payoff that gives lips a matte yet soft focus effect. 
                The soft matte formula is enriched with rose oil extracts from France which give your matte lips a moisturized, comfortable feel.</span>
        </div>
    </section>
...
<div class="pro-container">
    ...
    <div class="last_icon">
        <div class="last_icon_cus">
          ...
          <script src="lip-liner-1.js"></script>
</body>
</html>