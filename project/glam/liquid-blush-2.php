...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/liquid-blush-2.jpg" width="100%" alt="">
            </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute liquid blush-400gm (rose pink) </h4>
            <h2> ₹580 </h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=liquid-blush&id=2">  <button> ADD To Cart</button> </a>
