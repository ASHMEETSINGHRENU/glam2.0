...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/liquid-lip-2.jpg" width="100%" alt="">
            </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute Matte Ultimate liquid Lip Color-dark red/200gm </h4>
            <h2> ₹550 </h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=liquid-lipstick&id=2"><button> Add To Cart </button> </a>         
