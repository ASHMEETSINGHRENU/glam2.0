...
<head>
    ...
    <link rel="stylesheet" href="style/kajal-1.css">
...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/kajal-3.jpg" width="100%" alt="">
            </div>

            <div class="small-img-group">
                
                <div class="small-img-col" onclick="changeImage('images/kajal-1.jpg')">
                <img id="small-image" src="images/kajal-1.jpg" width="100%" alt=""  >
                </div>

                <div class="small-img-col" onclick="changeImage('images/kajal-2.jpg')">
                <img id="small-image" src="images/kajal-2.jpeg" width="100%" alt="">
                </div>

                <div class="small-img-col" onclick="changeImage('images/kajal-3.jpg')">
                <img id="small-image" src="images/kajal-3.jpg" width="100%" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute kajal - Blue  </h4>
            <h2> ₹459 </h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=kajal&id=3"><button> ADD To Cart</button></a>
            <h4> product details </h4>
            <span> This absoloute kajal gives you a niche look that looks glam on you . we have three very basic shades.</span>
        </div>
    </section>
