...
<head>
    ...
    <link rel="stylesheet" href="style/eyeliner-1.css">
...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/eyeliner-1.jpg" width="100%" alt="">
            </div>

            <div class="small-img-group">
                
                <div class="small-img-col" onclick="changeImage('images/eyeliner-1.jpg')">
                <img id="small-image" src="images/eyeliner-1.jpg" width="100%" alt=""  >
                </div>

                <div class="small-img-col" onclick="changeImage('images/eyeliner-2.jpg')">
                <img id="small-image" src="images/eyeliner-2.jpg" width="100%" alt="">
                </div>

                <div class="small-img-col"onclick="changeImage('images/eyeliner-3.jpg')">
                <img id="small-image" src="images/eyeliner-3.jpg" width="100%" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            <h6> MAC </h6>
            <h4>Asoloute eyeliner - Glitter /300gm</h4>
            <h2> ₹569 </h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=eyeliner&id=1"><button> ADD To Cart</button></a>
            <h4> product details </h4>
            <span>This eyeliner gives you a very nice look within a single apply only . A must try product with waterproof resistance . </span>
        </div>
    </section>
...
<div class="pro-container">
    ...
    <div class="last_icon">
        <div class="last_icon_cus">
          ...
          <script src="eyeliner-1.js"></script>
</body>
</html>