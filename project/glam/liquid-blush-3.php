...
<head>
    ...
    <link rel="stylesheet" href="style/liquid-blush-1.css">
...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/liquid-blush-3.jpg" width="100%" alt="">
            </div>

            <div class="small-img-group">
                
                <div class="small-img-col" onclick="changeImage('images/liquid-blush-1.jpg')">
                <img id="small-image" src="images/liquid-blush-1.jpg" width="100%" alt=""  >
                </div>

                <div class="small-img-col" onclick="changeImage('images/liquid-blush-2.jpg')">
                <img id="small-image" src="images/liquid-blush-2.jpg" width="100%" alt="">
                </div>

                <div class="small-img-col" onclick="changeImage('images/liquid-blush-3.jpg')">
                <img id="small-image" src="images/liquid-blush-3.jpg" width="100%" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute liquid blush-400gm (light pink)  </h4>
            <h2> ₹590</h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=liquid-blush&id=3"><button> ADD To Cart</button> </a>
            <h4> product details </h4>
            <span>This liquid blush has a very niche touch on your face with diffrent shades u can have a great look on your face . 
                This is one of the best product you will see at our website . </span>
        </div>
    </section>
...
<div class="pro-container">
    ...
    <div class="last_icon">
        <div class="last_icon_cus">
          ...
          <script src="liquid-blush-1.js"></script>
</body>
</html>