...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/lip-liner-2.jpeg" width="100%" alt="">
            </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute Ultimate Lip liner Color(dark shade)  </h4>
            <h2> ₹299 </h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=lip-liner&id=2"><button> Add To Cart </button> </a> 
