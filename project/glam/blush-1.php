...
<head>
    ...
    <link rel="stylesheet" href="style/blush-1.css">
...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/blush-1.jpg" width="100%" alt="">
            </div>

            <div class="small-img-group">
                
                <div class="small-img-col" onclick="changeImage('images/blush-1.jpg')">
                <img id="small-image" src="images/blush-1.jpg" width="100%" alt=""  >
                </div>

                <div class="small-img-col" onclick="changeImage('images/blush-2.jpg')">
                <img id="small-image" src="images/blush-2.jpg" width="100%" alt="">
                </div>

                <div class="small-img-col" onclick="changeImage('images/blush-3.jpg')">
                <img id="small-image" src="images/blush-3.jpg" width="100%" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute blush Color -light pink </h4>
            <h2> ₹799 </h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=blush&id=1"><button> ADD To Cart</button></a>
            <h4> product details </h4>
            <span>This blush has a very niche touch on your face with diffrent shades u can have a great look on your face . 
