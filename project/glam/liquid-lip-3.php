...
<head>
    ...
    <link rel="stylesheet" href="style/liquid-lip-1.css">
...
<header>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="largeImg">
            <img   id="MainImg" src="images/liquid-lip-3.jpg" width="100%" alt="">
            </div>

            <div class="small-img-group">
                
                <div class="small-img-col"  onclick="changeImage('images/liquid-lip-1.jpg')">
                <img id="small-image" src="images/liquid-lip-1.jpg" width="100%" alt=""  >
                </div>

                <div class="small-img-col" onclick="changeImage('images/liquid-lip-2.jpg')">
                <img id="small-image" src="images/liquid-lip-2.jpg" width="100%" alt="">
                </div>

                <div class="small-img-col" onclick="changeImage('images/liquid-lip-3.jpg')">
                <img id="small-image" src="images/liquid-lip-3.jpg" width="100%" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            <h6> Glam </h6>
            <h4>Glam Absolute Matte Ultimate liquid Lip Color - light pink /200gm</h4>
            <h2> ₹550</h2>
            <input type="number" value="1">
            <a href="mycart.php?action=add&type=liquid-lipstick&id=3"><button> Add To Cart </button> </a>
            <h4> product details </h4>
            <span>This soft matte lip colour has an intense colour payoff that gives liquid lips a matte yet soft focus effect. 
                The soft matte formula is enriched with rose oil extracts from France which give your matte liquid lips a moisturized, comfortable feel.</span>
        </div>
    </section>
...
<div class="pro-container">
    ...
    <div class="last_icon">
        <div class="last_icon_cus">
          ...
          <script src="liquid-lip-1.js"></script>
</body>
</html>